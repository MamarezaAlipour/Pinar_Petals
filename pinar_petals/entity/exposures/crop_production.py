...
from pinar.entity import Exposures, INDICATOR_IMPF
...
# default output directory: pinar_python/data/ISIMIP_crop/Output/Exposure
# by default the hist_mean files created by pinar_python/hazard/crop_potential are saved in
# pinar_python/data/ISIMIP_crop/Output/hist_mean/
