...
from pinar_petals.entity.exposures.black_marble import BlackMarble
from pinar.entity.exposures.litpop.nightlight import NOAA_BORDER
from pinar.entity.exposures.litpop import nightlight as nl_utils
...
class Test2013(unittest.TestCase):
    ...
    def test_spain_pass(self):
        ...
        with self.assertLogs('pinar_petals.entity.exposures.black_marble', level='INFO') as cm:
            ent.set_countries(country_name, 2013, res_km=1)
