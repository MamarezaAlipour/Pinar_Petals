...
from pinar.util.constants import ONE_LAT_KM
...
class WildFire(Hazard):
    ...
    def set_proba_fire_seasons(self, n_fire_seasons=1, n_ignitions=None,
        ...
        This method modifies self (pinar.hazard.WildFire instance)
        by adding probabilistic wildfire seasons.

        Parameters
        ----------
        self : pinar.Hazard.WildFire
    ...
    def combine_fires(self, event_id_merge=None, remove_rest=False,
        ...
        This method modifies self (pinar.hazard.WildFire instance) by
    ...
    def _run_one_fire(self):
        ...
        Parameters
        ----------
        self : pinar.hazard.WildFire instance
