...
from pinar.util import dates_times as dt
from pinar.util import coordinates as coord
...
# ! deposit the input files in: pinar_python/data/ISIMIP_crop/Input/Hazard
