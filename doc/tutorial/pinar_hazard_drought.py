...
#spei_file_dir = r'C:\Users\veron\Documents\ETH\HS18\PROJECT\GIT\pinar_python\data\system'
#spei_file_name = r'spei02.nc'
#spei_file_url = r'http://digital.csic.es/bitstream/10261/153475/4'

"""To define if the data are not in default path \pinar_python\data\system"""
#file_path_spei = r'C:\Users\veron\Documents\ETH\HS18\PROJECT\GIT\pinar_python\data\system\spei06.nc'
...
"""Set path if the data are not in 'pinar_python\data\system'"""
